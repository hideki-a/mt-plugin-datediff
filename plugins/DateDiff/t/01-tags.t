...
[
{ "r" : "1", "t" : "", "e" : ""},
{ "r" : "1", "t" : "<$mt:Date ts=\"20160609000000\" format=\"%Y%m%d\" setvar=\"tmp__today\"$><mt:DateDiff name=\"tmp__today\" interval=\"1\">OK<mt:Else>NG</mt:DateDiff>", "e" : "OK"},
{ "r" : "1", "t" : "<$mt:Date ts=\"20160609000000\" format=\"%Y%m%d\" setvar=\"tmp__today\"$><mt:DateDiff name=\"tmp__today\" interval=\"-1\">OK<mt:Else>NG</mt:DateDiff>", "e" : "OK"},
{ "r" : "1", "t" : "<$mt:Date ts=\"20160610000000\" format=\"%Y%m%d\" setvar=\"tmp__today\"$><mt:DateDiff name=\"tmp__today\" interval=\"2\">OK<mt:Else>NG</mt:DateDiff>", "e" : "OK"},
{ "r" : "1", "t" : "<$mt:Date ts=\"20160611000000\" format=\"%Y%m%d\" setvar=\"tmp__today\"$><mt:DateDiff name=\"tmp__today\" interval=\"2\">OK<mt:Else>NG</mt:DateDiff>", "e" : "NG"},
{ "r" : "1", "t" : "<$mt:Date ts=\"20160602000000\" format=\"%Y%m%d\" setvar=\"tmp__today\"$><mt:DateDiff name=\"tmp__today\" interval=\"-7\">OK<mt:Else>NG</mt:DateDiff>", "e" : "OK"},
{ "r" : "1", "t" : "<$mt:Date ts=\"20160601000000\" format=\"%Y%m%d\" setvar=\"tmp__today\"$><mt:DateDiff name=\"tmp__today\" interval=\"-7\">OK<mt:Else>NG</mt:DateDiff>", "e" : "NG"}
]
JSON
#=====
